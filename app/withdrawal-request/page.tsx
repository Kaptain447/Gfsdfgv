    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="text-center py-8 md:py-12">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">Withdrawal Request</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Submit a secure withdrawal request from your Famous FX investment account. All requests are processed
            according to our withdrawal policy and security procedures.
          </p>
        </section>
