...
export default function WithdrawalPolicyLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
        <div className="text-center">
          <BrandedLoading message="Loading Policy Information..." size="lg" showProgress={true} />
          <div className="mt-8 space-y-2 text-gray-600">
            <p className="text-sm">Retrieving latest policy updates</p>
            <p className="text-sm">Loading cryptocurrency guidelines</p>
            <p className="text-sm">Preparing security information</p>
          </div>
        </div>
      </div>
    </div>
