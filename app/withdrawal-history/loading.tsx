...
export default function WithdrawalHistoryLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
        <div className="text-center">
          <BrandedLoading message="Loading Transaction History..." size="lg" showProgress={true} />
          <div className="mt-8 space-y-2 text-gray-600">
            <p className="text-sm">Fetching withdrawal records</p>
            <p className="text-sm">Calculating fee savings</p>
            <p className="text-sm">Organizing transaction data</p>
          </div>
        </div>
      </div>
    </div>
